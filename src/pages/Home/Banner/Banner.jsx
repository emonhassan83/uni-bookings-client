    ...
    <div className="banner__container md:text-center">
      <Container>
        <div className="md:w-3/4 mx-auto md:text-center">
          <h1 className="primary-font pt-28 md:pt-40 lg:pt-[25vh] text-4xl  md:text-6xl text-white">
            UniBookings Helping You Discover
          </h1>
          <h4 className="primary-font mt-6 font-semibold text-white text-base md:text-lg">
